...
def carregar_tabelas() -> dict[str, dict]:
    ...
    return {
        tabela: {
            ...
            "coluna_watermark_ts": cfg.get("coluna_watermark_ts"),
            "append_idempotente": cfg.get("append_idempotente", False),
            "tabela_cabecalho": cfg.get("tabela_cabecalho"),
            "coluna_watermark_cabecalho": cfg.get("coluna_watermark_cabecalho"),
            "coluna_watermark_cabecalho_ts": cfg.get("coluna_watermark_cabecalho_ts"),
